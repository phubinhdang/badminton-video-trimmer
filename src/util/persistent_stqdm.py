...
class PersistentSTQDM(tqdm):  # pylint: disable=invalid-name
    """
    Change two behavior of https://github.com/Wirg/stqdm
    1. Display in the sidebar (st.sidebar)
    2. Still display after the progress finished by modifying close() method.
    """
