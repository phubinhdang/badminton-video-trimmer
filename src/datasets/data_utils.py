...
def get_dataset_info(dataset, feature):
    ...
    # {'train': 'val', 'val': 'test'}
    # {'local_path': 'data/badminton/img10fps', 'format': 'jpg', 'fn_templ': '%s', 'img_fn_templ': '/img_%07d.jpg'}
    # 'data/badminton/badminton_annotations_with_fps_duration.json'
    # 'data/badminton/badminton_img10fps_info.json'
